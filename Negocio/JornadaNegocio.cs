...
namespace Negocio
{
    public class JornadaNegocio
    {
            ...
            try
            {
                ...
                while (datos.Lector.Read())
                {
                    ...
                    Jornada _jornada = new Jornada
                    {
                        ...
                        hora_Fin = datos.Lector["HORA_FIN"] is DBNull ? TimeSpan.Zero : (TimeSpan)datos.Lector["HORA_FIN"], 
                    };
        ...
        public void InsertarJornada(Jornada _jornada)
        {
            ...
            try
            {
                datos.setConsulta("INSERT INTO JORNADAS (FECHA, HORA_INICIO, ESTADO) VALUES(@FECHA, @HORA_INI, @ESTADO)");
        ...
        public void CerrarJornada(Jornada _jornada)
        {
            AccesoDatos datos = new AccesoDatos();
            try
            {
                int id = 0;
                id= BuscarIdJornadaActiva();
                datos.setearProcedimiento("SP_CERRAR_JORNADA");
                datos.setParametro("@IDJORNADA", id);
        ...
        public int BuscarIdJornadaActiva()
        {
            AccesoDatos datos = new AccesoDatos();
            try
            {
                datos.setConsulta("SELECT ID_JORNADA FROM JORNADAS WHERE ESTADO = 1");
                datos.ejecutarLectura();
        ...
        public bool BuscarJornadaActiva()
        {
            AccesoDatos datos = new AccesoDatos();
            try
            {
